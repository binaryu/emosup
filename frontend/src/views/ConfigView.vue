<template>
  <div>
    <PageHeaderCard title="系统配置" subtitle="配置 OpenList、aria2、Emos 与任务调度参数。修改后需保存生效。">
        ...
        <el-card class="config-card">
          ...
          <el-form label-width="100px" label-position="top">
            ...
            <el-form-item label="Token">
              <el-input v-model="configStore.config.emos.token" type="password" show-password placeholder="Bearer Token" />
            </el-form-item>
            <el-form-item label="存储位置">
              <el-select v-model="configStore.config.emos.storage">
